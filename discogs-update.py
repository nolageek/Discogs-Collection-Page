...
import getopt, sys, json, urllib, os.path
...
def download_folder_data():
	...
	for folder in folders['folders']:
		...
		urllib.urlretrieve(DISCOGS_API_URL + "/users/" + DISCOGS_USERNAME + "/collection/folders/" + str(folder['id']) + "/releases?sort=added&sort_order=asc&per_page=" + PER + "&token=" + DISCOGS_TOKEN,DATA_DIR + str(folder['id']) + " -added-asc.json")
		urllib.urlretrieve(DISCOGS_API_URL + "/users/" + DISCOGS_USERNAME + "/collection/folders/" + str(folder['id']) + "/releases?sort=added&sort_order=desc&per_page=" + PER + "&token=" + DISCOGS_TOKEN,DATA_DIR + str(folder['id']) + "-added-desc.json")
		urllib.urlretrieve(DISCOGS_API_URL + "/users/" + DISCOGS_USERNAME + "/collection/folders/" + str(folder['id']) + "/releases?sort=artist&sort_order=asc&per_page=" + PER + "&token=" + DISCOGS_TOKEN,DATA_DIR + str(folder['id']) + "-artist-asc.json")
		urllib.urlretrieve(DISCOGS_API_URL + "/users/" + DISCOGS_USERNAME + "/collection/folders/" + str(folder['id']) + "/releases?sort=artist&sort_order=desc&per_page=" + PER + "&token=" + DISCOGS_TOKEN,DATA_DIR + str(folder['id']) + "-artist-desc.json")
